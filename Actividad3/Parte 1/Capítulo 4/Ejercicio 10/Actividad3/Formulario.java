...
public class Formulario extends javax.swing.JFrame {
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        try{
            ...
            int patrimonio = Integer.parseInt(jTextField4.getText());
            int estrato = Integer.parseInt(jTextField5.getText());
            
            JOptionPane.showMessageDialog(null, "Numero de inscripcion "+ num);
            JOptionPane.showMessageDialog(null, "Nombres "+ nombres);
            JOptionPane.showMessageDialog(null, "Pago de matricula : " + Logica.matricula(patrimonio, estrato));
        
        }
        catch(Exception e){ 
            JOptionPane.showMessageDialog(null, "Error en la entrada de datos (verificar entradas)");
        }
